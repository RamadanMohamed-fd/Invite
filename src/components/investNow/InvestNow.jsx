...
const InvestNow = (props) => {
  ...
  return (
    ...
    >
      <h2 data-aos="fade-down" className="text-[#343935]  inv_title text ">
        Invest in better
      </h2>
      ...
      >
        Become an investor for a brighter future for craftsmen of our country
        and for yourself
      </p>
      <div
        data-aos="fade-up"
      ...
      >
        <a className="mx-2 text1 ">Invest Now</a>
